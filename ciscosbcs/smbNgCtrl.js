define(["angular"], function(angular) {
  ...
  ciscosbcs.directive('chooseTableCol', ["$timeout", function($timeout) {
    return {
        ...
        templateUrl: "script/ciscosbcs/views/chooseTableColView.html",
  ...
  ciscosbcs.directive('regularTable', ["$filter","$timeout", function($filter, $timeout) {
    return {
      restrict: 'E',
        ...
        templateUrl: "script/ciscosbcs/views/regularTableTemplate.html",
  ...
  ciscosbcs.directive('complexTable', ["$filter", "$timeout", function($filter, $timeout) {
    return {
      restrict: 'E',
        ...
        templateUrl: "script/ciscosbcs/views/complexTableTemplate.html",
        controller:function($scope,$element,$transclude){
          // pagination
          $scope.conf = {
            currentPage: 1,
